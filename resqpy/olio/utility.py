...
def cell_count_from_extent(extent) -> int:
...
def string_ijk1_for_cell_kji0(cell_kji0) -> str:
...
def string_ijk1_for_cell_ijk1(cell_ijk1) -> str:
...
def string_ijk_for_extent_kji(extent_kji) -> str:
