...
__all__ = [
    ...
    'find_intersections_of_trajectory_with_surface', 'find_intersections_of_trajectory_with_layer_interface',
    'find_first_intersection_of_trajectory_with_surface', 'find_first_intersection_of_trajectory_with_layer_interface',
    'find_first_intersection_of_trajectory_with_cell_surface', 'find_intersection_of_trajectory_interval_with_column_face',
    ...
    'find_faces_to_represent_surface_regular_optimised', 'find_faces_to_represent_surface',
    'bisector_from_faces', 'column_bisector_from_faces', 'shadow_from_faces', 'get_boundary',
