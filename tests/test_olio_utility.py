...
@pytest.mark.parametrize("test_input,expected_output", [
    (np.array([2, 5, 3]), np.array([2, 4, 1])),
    (np.array([-3, 0, -6]), np.array([-7, -1, -4])),
...
@pytest.mark.parametrize("test_input,expected_output", [
    (np.array([2, 4, 1]), np.array([2, 5, 3])),
    (np.array([-7, -1, -4]), np.array([-3, 0, -6])),
...
@pytest.mark.parametrize("test_input,expected_output", [
    (np.array([2, 5, 3]), np.array([3, 5, 2])),
    (np.array([-3, 0, -6]), np.array([-6, 0, -3])),
...
@pytest.mark.parametrize("test_input,expected_output", [
    (np.array([2, 5, 3]), '[4, 6, 3]'),
    (np.array([-3, 0, -6]), '[-5, 1, -2]'),
...
@pytest.mark.parametrize("test_input,expected_output", [
    (np.array([2, 5, 3]), '[2, 5, 3]'),
    (np.array([-3, 0, -6]), '[-3, 0, -6]'),
...
@pytest.mark.parametrize("test_input,expected_output", [
    (np.array([2, 5, 3]), '[3, 5, 2]'),
    (np.array([-3, 0, -6]), '[-6, 0, -3]'),
...
@pytest.mark.parametrize("test_input,expected_output", [
    (np.array([26.1, 5.0, 32.8]), '(26.10, 5.00, 32.800)'),
