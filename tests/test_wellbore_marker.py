...
def test_WellboreMarker(example_model_and_crs):
    ...
    fluid_contact_feature_uuid = fluid_contact_feature1.uuid

    # --------- Act ----------
    # Create a wellbore marker object
    wellbore_marker_1 = resqpy.well.WellboreMarker(parent_model = model, parent_frame = wellbore_marker_frame,
                                                   marker_index = 0, marker_type = 'horizon',
                                                   interpretation_uuid = horizon_interp_uuid, title = 'Horizon1_marker')

    wellbore_marker_2 = resqpy.well.WellboreMarker(parent_model = model, parent_frame = wellbore_marker_frame,
                                                   marker_index = 1, marker_type = 'gas oil contact',
                                                   title = 'GOC_marker')
    ...
    wellbore_marker_3 = resqpy.well.WellboreMarker(parent_model = model, parent_frame = wellbore_marker_frame, marker_index = 2, marker_node = wbm_node_1)
    ...
    assert wellbore_marker_3.title == 'wellbore marker'
    assert wellbore_marker_3.marker_type == wellbore_marker_1.marker_type
