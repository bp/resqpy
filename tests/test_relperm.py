...
from resqpy.olio.relperm import RelPerm\
    # , text_to_relperm_dict, relperm_parts_in_model
...
class TestRelPerm(unittest.TestCase):
    ...
    #     dataframe1 = RelPerm(model=self.model, df=df1, uom_list=uom_list, phase_combo=phase_combo1, low_sal=low_sal,
    #                          title='table1')
    #     dataframe2 = RelPerm(model=self.model, df=df2, uom_list=uom_list, phase_combo=phase_combo2, low_sal=low_sal,
    #                          title='table2')
