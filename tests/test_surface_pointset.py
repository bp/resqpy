...
def test_from_charisma_method(mocker, example_model_and_crs):
    ...
    array = np.array([[420691.19624, 6292314.22044, 2799.05591],
                      [420680.15765, 6292308.35532, 2798.08496]])
...
def test_from_irap_method(mocker, example_model_and_crs):
    ...
    array = np.array([[429450.658333, 6296954.224574, 2403.837646],
                      [429444.793211, 6296965.263155, 2403.449707]])
...
@pytest.mark.parametrize('closed,coords1,coords2,expected',
                         [(True, np.array([[2, 2, 2], [3, 3, 3], [2, 2, 2]]), np.array([[1, 1, 1]]),
                           np.array([[1, 1, 1], [2, 2, 2], [3, 3, 3]])),
                          (False, np.array([[2, 2, 2], [3, 3, 3], [2, 2, 2]]), np.array([[1, 1, 1]]),
                           np.array([[1, 1, 1], [2, 2, 2], [3, 3, 3], [2, 2, 2]]))])
