...
def test_slice_points_k(aligned_regular_grid):
    ...
    e = np.array([[(0.0, 0.0, 0.0), (100.0, 0.0, 0.0), (200.0, 0.0, 0.0), (300.0, 0.0, 0.0), (400.0, 0.0, 0.0)],
                  ...
                  [(0.0, 100.0, 0.0), (100.0, 100.0, 0.0), (200.0, 100.0, 0.0), (300.0, 100.0, 0.0), (400.0, 100.0, 0.0)],
                  [(0.0, 150.0, 0.0), (100.0, 150.0, 0.0), (200.0, 150.0, 0.0), (300.0, 150.0, 0.0), (400.0, 150.0, 0.0)]])
