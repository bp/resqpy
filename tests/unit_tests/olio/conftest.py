...
18    28    5    NA    0.320   0.000   NA      NA    ON      5.000     88.720   86.800   9193.400
            """
        )
...
def test_well_dataframe_duplicates_removed() -> pd.DataFrame:
    ...
    return pd.DataFrame(
        {
            "IW": {0: 18, 2: 18, 3: 18, 5: 18},
            "JW": {0: 28, 2: 28, 3: 28, 5: 28},
            "L": {0: 2, 2: 3, 3: 4, 5: 5},
            "KH": {0: np.nan, 2: np.nan, 3: np.nan, 5: np.nan},
            "RADW": {0: 0.32, 2: 0.32, 3: 0.32, 5: 0.32},
            "SKIN": {0: 0.0, 2: 0.0, 3: 0.0, 5: 0.0},
            "RADB": {0: np.nan, 2: np.nan, 3: np.nan, 5: np.nan},
            "WI": {0: np.nan, 2: np.nan, 3: np.nan, 5: np.nan},
            "STAT": {0: "ON", 2: "OFF", 3: "ON", 5: "ON"},
            "LENGTH": {0: 5.0, 2: 5.0, 3: 5.0, 5: 5.0},
            "ANGLV": {0: 88.08, 2: 88.08, 3: 88.08, 5: 88.72},
            "ANGLA": {0: 86.8, 2: 86.8, 3: 86.8, 5: 86.8},
            "DEPTH": {0: 9165.28, 2: 9165.28, 3: 9165.28, 5: 9193.4},
        }
    )
...
def test_well_dataframe_duplicates_kept() -> pd.DataFrame:
    ...
    return pd.DataFrame(
        {
            "IW": {0: 18, 1: 18, 2: 18, 3: 18, 4: 18, 5: 18},
