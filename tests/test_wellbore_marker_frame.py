...
def test_get_trajectory_object(example_model_and_crs):
    ...
    # --------- Act ----------
    # Get the trajectory object from an uuid
    found_trajectory = wellbore_marker_frame.get_trajectory_obj(trajectory_uuid = trajectory_uuid)

    # --------- Assert ----------
    found_trajectory == trajectory
...
def test_find_marker_from_interp(example_model_and_crs):
    ...
    # --------- Assert ----------
    found_marker1 = wellbore_marker_frame.wellbore_marker_list[2]
    found_marker2 = wellbore_marker_frame.wellbore_marker_list[1]
...
def test_find_marker_from_index(example_model_and_crs):
    ...
    # --------- Act ----------
    # Get the marker object from an interpretation object and interpretation object uuid
    found_marker1 = wellbore_marker_frame.find_marker_from_index(0)

    # --------- Assert ----------
    found_marker1 = wellbore_marker_frame.wellbore_marker_list[0]